...
public class PolicyAPI {
    ...
    public Response getProducts(@QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {
        ...
        try {
            ...
            queryUtil.saveLog(setWebserviceLog(traceId, requestTime, username, methodName, response.getStatus(), queryExecuted, HttpMethod.GET, errorCause, sessionId, headers.getRemoteAddr()));
        }
    ...
    public Response getSubProducts(@QueryParam("productId") String productId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {
        ...
        LOGGER.info("{} is being called with parameter. productId -> {}, username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", methodName, productId, username, sessionId, traceId, headers.getRemoteAddr());
        ...
        try {
            ...
            queryUtil.saveLog(setWebserviceLog(traceId, requestTime, username, methodName, response.getStatus(), queryExecuted, HttpMethod.GET, errorCause, sessionId, ipAddress));
        }
    ...
    public Response createPolicy(PolicyRequest policyRequest, @Context HttpServletRequest headers) {
        ...
        if (policyRequest != null) {
            ...
            try {
                ...
                queryUtil.saveLog(setWebserviceLog(traceId, requestTime, "web", methodName, response.getStatus(), queryExecuted, HttpMethod.POST, errorCause, policyRequest.getSessionId(), headers.getRemoteAddr(), false, "Create Policy", null));
    ...
    public Response getProductConfig(@QueryParam("subProductId") Long subProductId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {
        ...
        try {
            ...
            queryUtil.saveLog(setWebserviceLog(reqRes, requestTime, username, methodName, response.getStatus(), queryExecuted, HttpMethod.GET, errorCause, sessionId, ipAddress));
        }
        return response;
    ...
    public Response getBeneficiaries(@QueryParam("insurancePolicyId") String insurancePolicyId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {
        ...
        LOGGER.info("{} is being called with parameter. insurancePolicyId -> {}, username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", methodName, insurancePolicyId, username, sessionId, reqRes, headers.getRemoteAddr());
        ...
        try {
            ...
            queryUtil.saveLog(setWebserviceLog(reqRes, requestTime, username, methodName, response.getStatus(), queryExecuted, HttpMethod.GET, errorCause, sessionId, headers.getRemoteAddr()));
        }
        return response;
    ...
    public Response cancelPolicy(PolicyCancelRequest policyCancelRequest, @Context HttpServletRequest headers) {
        ...
        if (policyCancelRequest != null) {
            ...
            try {
                ...
                int updated = insurancePolicyInterface.cancelPolicy(today(), setStatus(Statuses.CANCELLED.toString()), policyCancelRequest.getUsername(), policyCancelRequest.getPolicyId());
                ...
                queryUtil.saveLog(setWebserviceLog(reqRes, requestTime, policyCancelRequest.getUsername(), methodName, response.getStatus(), queryExecuted, HttpMethod.POST, errorCause, policyCancelRequest.getSessionId(), headers.getRemoteAddr()));
            }
        } else {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getMemberPrice(@QueryParam("subProductId") Long subProductId, @QueryParam("benefitCycle") Long benefitCycle, @QueryParam("dateOfBirth") String dateOfBirth, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {

        String reqRes = getLogId();
        String methodName = "getMemberPrice";
        LOGGER.info("{} is being called with parameter. subProductId -> {}, username -> {}, sessionId -> {}, logId -> {}, benefitCycle - {}, dateOfBirth -. {}, ipAddress -> {} ", methodName, subProductId, username, sessionId, reqRes, benefitCycle, dateOfBirth, headers.getRemoteAddr());
        ...
        try {
            ...
            Optional<MemberProductPrice> memberProductPrices = memberProductPriceInterface.findBySubProduct(subProduct, age, setBenefitCycle(benefitCycle));
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getPaymentLog(@QueryParam("startDate") String startDate, @QueryParam("endDate") String endDate, @QueryParam("policyId") String policyId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @QueryParam("status") String status, @Context HttpServletRequest headers) {

        String reqRes = getLogId();
        String methodName = "getPaymentSchedule";
        LOGGER.info("{} is being called with parameter. startDate -> {}, endDate -> {}, policyId -> {}, username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", methodName, startDate, endDate, policyId, username, sessionId, reqRes, headers.getRemoteAddr());
    ...
    public Response updatePolicy(PolicyRequest policyRequest, @Context HttpServletRequest headers) {
        ...
        if (policyRequest != null) {
            ...
            try {
                ...
                queryUtil.saveLog(setWebserviceLog(traceId, requestTime, policyRequest.getUsername(), methodName, response.getStatus(), queryExecuted, HttpMethod.POST, errorCause, policyRequest.getSessionId(), headers.getRemoteAddr()));
            }
        } else {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getPaymentStatus(@QueryParam("policyId") String policyId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @QueryParam("status") String status, @QueryParam("startDate") String startDate, @QueryParam("endDate") String endDate, @Context HttpServletRequest headers) {

        String traceId = getLogId();
        String methodName = "getPaymentStatus";
        LOGGER.info("{} is being called with parameter.  policyId -> {}, username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", policyId, methodName, username, sessionId, traceId, headers.getRemoteAddr());
    ...
    public Response updateSubProduct(SubProductUpdate subProductUpdate, @Context HttpServletRequest headers) {
        ...
        if (subProductUpdate == null) {
            ...
            try {
                ...
                queryUtil.saveLog(setWebserviceLog(traceId, requestTime, subProductUpdate.getUsername(), methodName, response.getStatus(), queryExecuted, HttpMethod.POST, errorCause, subProductUpdate.getSessionId(), headers.getRemoteAddr()));
            }
        }
        ...
        if (subProductUpdate == null) {
            ...
            try {
                ...
                if (users.isPresent()) {
                    ...
                    Optional<ProductConfig> productConfigDB = productConfigInterface.findBySubProductAndStatus(setSubProduct(subProductUpdate.getSubProductId()), setActive());
        ...
        if (beneficiaryRequest == null) {
            ...
            try {
                ...
                if (beneficiaryRequest.getOperationType().equals(OperationTypes.REMOVE.toString())) {
                    ...
                    int updatedBeneficiary = beneficiariesInterface.updateBeneficiary(today(), beneficiaryRequest.getUsername(), status, beneficiaryRequest.getMemberRequest().getBeneficiaryId());
                    ...
                    int updatedBeneficiary = beneficiariesInterface.updateBeneficiary(memberRequest.getName(), stringToDate(memberRequest.getDateOfBirth()), setIDType(memberRequest.getIdTypeId()), memberRequest.getBenStudent(), setRelationShip(memberRequest.getRelationShipId()), today(), beneficiaryRequest.getUsername(), insurancePolicy, memberRequest.getTotalCharge().doubleValue(), memberRequest.getBeneficiaryId());
                ...
                queryUtil.saveLog(setWebserviceLog(traceId, requestTime, beneficiaryRequest.getUsername(), methodName, response.getStatus(), queryExecuted, HttpMethod.POST, errorCause, beneficiaryRequest.getSessionId(), headers.getRemoteAddr()));
            }
        }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAccountDetails(@QueryParam("subProductId") Long subProductId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @QueryParam("currencyId") String currencyId, @Context HttpServletRequest headers) {

        String reqRes = getLogId();
        String methodName = "getAccountDetails";
        String ipAddress = headers.getRemoteAddr();
        LOGGER.info("{} is being called with parameter.  subProductId -> {} ,currencyId -> {}, username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", subProductId, currencyId, methodName, username, sessionId, reqRes, headers.getRemoteAddr());
        ...
        try {
            ...
            Optional<SubProductAccount> subProductAccount = subProductAccountInterface.findBySubProductAndCurrencyAndStatus(setSubProduct(subProductId), setCurrency(currencyId), setActive()
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getInsuranceHistory(@QueryParam("policyId") String policyId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {

        String reqRes = getLogId();
        String methodName = "getInsuranceHistory";
        String ipAddress = headers.getRemoteAddr();
        LOGGER.info("{} is being called with parameter.  policyId -> {} , username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", methodName, policyId, username, sessionId, reqRes, headers.getRemoteAddr());
        ...
        try {
            ...
            List<InsurancePolicyHistory> insurancePolicyHistories = insurancePolicyHistoryInterface.findByInsurancePolicyOrderByCreatedDateDesc(insurancePolicy);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Transactional
    public Response reopenPolicy(PolicyReopenRequest policyReopenRequest, @Context HttpServletRequest headers) {

        String reqRes = getLogId();
        String methodName = "reopenPolicy";
        String ipAddress = headers.getRemoteAddr();
        LOGGER.info("{} is being called with parameters. request -> {}, logId -> {}, ipAddress -> {} ", policyReopenRequest, methodName, reqRes, headers.getRemoteAddr());
        ...
        try {
            ...
            int updated = insurancePolicyInterface.cancelPolicy(today(), setStatus(Statuses.ACTIVE.toString()), policyReopenRequest.getUsername(), policyReopenRequest.getPolicyId());
            ...
            queryUtil.saveLog(setWebserviceLog(reqRes, requestTime, policyReopenRequest.getUsername(), methodName, response.getStatus(), queryExecuted, HttpMethod.POST, errorCause, policyReopenRequest.getSessionId(), ipAddress));
        }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getProductByType(@QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @QueryParam("productType") String productType, @Context HttpServletRequest headers) {

        String reqRes = getLogId();
        String methodName = "getProductsByType";
        String ipAddress = headers.getRemoteAddr();
        LOGGER.info("{} is being called with parameter. username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", methodName, username, sessionId, reqRes, headers.getRemoteAddr());
    ...
    public Response getBeneficiariesPrice(@QueryParam("subProductId") Long subProductId, @QueryParam("benefitCycle") Long benefCycle, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {
        ...
        String ipAddress = headers.getRemoteAddr();
        LOGGER.info("{} is being called with parameter. subProductId -> {}, benefitCycle ->{}," + " username -> {}, sessionId -> {}, logId -> {}, ipAddress -> {} ", subProductId, benefCycle, methodName, username, sessionId, reqRes, ipAddress);
        ...
        try {
            ...
            List<BeneficiaryPriceResponse> beneficiaryPriceResponses = memberPriceInterface.findBySubProductAndBenefitCycleAndStatus(setSubProduct(subProductId), setBenefitCycle(benefCycle), setActive()).stream().map(m -> new BeneficiaryPriceResponse(m.getAmount(), m.getBeneficiaryDescription() + "( " + m.getMinAge() + " - " + m.getMaxAge() + ")")).collect(Collectors.toList());
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response fetchPolicyByPhoneNumber(@QueryParam("phoneNumber") String phoneNumber, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {
        String reqRes = getLogId();
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response fetchPolicyByPhoneNumberAndInsurance(@QueryParam("phoneNumber") String phoneNumber, @QueryParam("insurancePolicyId") String insurancePolicyId, @QueryParam("sessionId") String sessionId, @QueryParam("username") String username, @Context HttpServletRequest headers) {
        String reqRes = getLogId();
