...
/**
 * <p>Java class for SBInsuranceTable complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SBInsuranceTable">
 *   &lt;complexContent>
...
@XmlType(name = "SBInsuranceTable", propOrder = {
    "webRequestCommon",
    "ofsFunction",
    "ebsbsegurosinsmigrationType"
})
public class SBInsuranceTable {
    ...
    public String toString() {
        return "SBInsuranceTable{" +
                "webRequestCommon=" + webRequestCommon +
                ", ofsFunction=" + ofsFunction +
                ", ebsbsegurosinsmigrationType=" + ebsbsegurosinsmigrationType +
                '}';
    }
}
